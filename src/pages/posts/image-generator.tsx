...
import { ImageGenerator as Generator } from '../../components/image-generator/image-generator';
...
const ImageGenerator = () => {
  ...
  const { post, users } = useAppSelector((state) => selectSinglePost(state, 'Image-generator'));
